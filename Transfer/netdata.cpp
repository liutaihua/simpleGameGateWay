...
unsigned int CSDProtocol::GetMaxMsgId()
{
	return m_nMaxMsgId ;
}

void CSDProtocol::SetMaxMsgId(const unsigned int nMaxMsgId)
{
	m_nMaxMsgId = nMaxMsgId ;
}

unsigned int CSDProtocol::GetMinMsgId()
{
	return m_nMinMsgId ;
}

void CSDProtocol::SetMinMsgId(const unsigned int nMinMsgId)
{
	m_nMinMsgId = nMinMsgId ;
}

std::vector<int>* CSDProtocol::GetMsgList()
{
	return &m_vMsgList ;
}
