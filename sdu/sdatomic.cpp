...
namespace Crown
{
    ...
    {
#if (defined(WIN32) || defined(WIN64))
        return InterlockedExchangeAdd((volatile ulong *)mem, val);
#else
...
#if (defined(WIN32) || defined(WIN64))
        return InterlockedIncrement((volatile ulong *)mem) - 1;
#elif defined(LINUX) || defined(APPLE)
    ...
    {
#if (defined(WIN32) || defined(WIN64))
        return InterlockedDecrement((volatile ulong *)mem) + 1;
#elif defined(LINUX) || defined(APPLE)
        unsigned char prev;
    ...
    {
#if (defined(WIN32) || defined(WIN64))
        InterlockedExchange((volatile ulong *)mem, val);
#else
        *mem = val;
#endif
    }
    ...
    {
#if (defined(WIN32) || defined(WIN64))
        return InterlockedCompareExchange((volatile ulong *)mem, with, cmp);
#elif defined(LINUX) || defined(APPLE)
        uint32 prev;
    ...
    {
#if (defined(WIN32) || defined(WIN64))
        return InterlockedExchange((volatile ulong *)mem, val);
#elif defined(LINUX) || defined(APPLE)
        int32 prev = val;
