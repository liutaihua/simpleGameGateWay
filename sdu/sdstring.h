...
#define SDIsDigit(c) (isdigit(((byte)(c))))
...
#define SDAtoi64 atoll
    ...
    * @return 去掉字符ch后的字符串
    */
    std::string SDAPI SDStrTrimLeft(std::string &pszStr, const char *pTrimStr = " \r\t\n");
    ...
    * @return 去掉字符ch后的字符串
    */
    std::string SDAPI SDStrTrimRight(std::string &pszStr, const char *pTrimStr = " \r\t\n");
    ...
    * @return 去掉字符ch后的字符串
    */
    std::string SDAPI SDStrTrim(std::string &pszStr, const char* pTrimStr = " \r\t\n");
