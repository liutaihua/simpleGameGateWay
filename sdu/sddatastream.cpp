...
namespace Crown
{
    ...
    int32 SDAPI CSDDataStream::AddFloat(float fFloat)//08-10-06 liujunhui add: 增加解析real
    {
    ...
    int32 SDAPI CSDDataStream::DelFloat(float &fFloat)//08-10-06 liujunhui add: 增加解析real
    {
        if(m_pos + (int32)sizeof(fFloat) > m_bufLen)
            return -1;
