  ...
  : public null_type, public ptr_manager, public single_cast_stub
{
  ...
  {
    // Commented by Logan(xorcererzc@gmail.com, make it nothrow while calling empty signal).
...
public:
  ...
  FD_DELEGATE_DELEGATE(UR (U::*fxn)(FD_DELEGATE_TEMPLATE_ARGS2), T t)
  {
    struct select_stub
    {
      ...
      typedef typename boost::mpl::if_c<( sizeof( TFxn ) <= detail::delegate::any_fxn_size ),
